...
mkdir -p example_cpu_umpire
cd example_cpu_umpire
...
python3  ../../../boba_builder.py \
  ...
  --UMPIRE_DIR ${BOBA_TPL_FARM}/install/umpire_cpu \
  --CAMP_DIR ${BOBA_TPL_FARM}/install/camp_cpu \
...
cmake \
  ...
  -DBOBA_ENABLE_CAMP=On \
  -DBOBA_ENABLE_CALIPER=Off \
  -DBOBA_ENABLE_UMPIRE=On \
  -DBOBA_UMPIRE=On \
